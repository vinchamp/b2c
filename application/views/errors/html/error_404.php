...
<html lang="en">
<head>
  <title><?php echo SITE_NAME; ?> 404 Page Not Found</title>
  <meta charset="utf-8">
	...
	<div class="row header_bg">
									...
									<div class="modal-body">
										<div class="row modal_paddng">
											<div class="col-sm-6 col-md-6 col-lg-6 modal_content">
												<a href="customer_login.html"><i><img src="<?php echo base_url();?>assets/front/img/user.png" alt="image"></i> Customer Login</a>
											</div>
											<div class="col-sm-6 col-md-6 col-lg-6  modal_content">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="col-sm-3 col-md-3 col-lg-3 logo">
				<h1><a href="index.html"><img src="<?php echo base_url();?>assets/front/img/logo.png" class="img-responsive" alt="Logo"></a></h1>
			</div>
